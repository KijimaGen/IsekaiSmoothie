...
public class MasterDataManager{
    ...
    //読み込んだマスターデータ
    public static List<List<Entity_CustomerMasterData.Param>> customerData = null;

    public static void LoadAllData() {
        customerData = Load<Entity_CustomerMasterData, Entity_CustomerMasterData.Sheet, Entity_CustomerMasterData.Param>("CustomerMasterData");
    }
